<form method="POST" action="<?= URL ?>jugadores/mostrarJugador" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input disabled type="text" value = "<?= $this->jugador['nombre'] ?>" class="form-control" name="nombre" placeholder="">
        <small id="nameHelp" class="form-text text-danger"><?= (isset($this->errores['nombre']))? $this->errores['nombre']:null?></small>
    </div>

    <div class="form-group">
        <label for="inputapellidos">Apellidos</label>
        <input disabled type="text" value = "<?= $this->jugador['apellidos'] ?>" class="form-control" name="apellidos" >
    ...
    <div class="form-group">
        ...
        <select disabled class="form-control" name="equipo_id">
    ...
    <div class="form-group">
        ...
        <input disabled type="text" value = "<?= $this->jugador['nacionalidad'] ?>"class="form-control" name="nacionalidad" >
    ...
    <div class="form-group">
        ...
        <input disabled type="date" value = "<?= $this->jugador['fechaNac'] ?>"class="form-control" name="fechaNac" >
    ...
    <div class="form-group">
        ...
        <input disabled type="text" value = "<?= $this->jugador['draft'] ?>"class="form-control" name="draft">
